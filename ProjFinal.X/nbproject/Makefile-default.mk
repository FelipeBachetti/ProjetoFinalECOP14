...
SOURCEFILES_QUOTED_IF_SPACED=adc.c atraso.c io.c keypad.c lcd.c pwm.c rgb.c serial.c so.c main.c ssd.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/adc.p1 ${OBJECTDIR}/atraso.p1 ${OBJECTDIR}/io.p1 ${OBJECTDIR}/keypad.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/rgb.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/so.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/ssd.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/atraso.p1.d ${OBJECTDIR}/io.p1.d ${OBJECTDIR}/keypad.p1.d ${OBJECTDIR}/lcd.p1.d ${OBJECTDIR}/pwm.p1.d ${OBJECTDIR}/rgb.p1.d ${OBJECTDIR}/serial.p1.d ${OBJECTDIR}/so.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/ssd.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/adc.p1 ${OBJECTDIR}/atraso.p1 ${OBJECTDIR}/io.p1 ${OBJECTDIR}/keypad.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/rgb.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/so.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/ssd.p1

# Source Files
SOURCEFILES=adc.c atraso.c io.c keypad.c lcd.c pwm.c rgb.c serial.c so.c main.c ssd.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/ProjFinal.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/ProjFinal.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/ProjFinal.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/ProjFinal.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/ProjFinal.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/ProjFinal.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/ProjFinal.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
